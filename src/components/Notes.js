...
<Link  to="/" style={{color: '#01579b', marginTop: '20px',marginRight: '60px', marginLeft: '30px', textDecoration:"none",fontSize:"20px" }} > Add new list <i style={{color: '#01579b', marginLeft:"20px"}} class="fa fa-plus" aria-hidden="true"></i></Link></Typography  >
 ...
 <Typography style={{fontWeight:"bold", fontSize:'50px', color: '#FFFFFF', marginLeft:"30px"}}>Notes 
 <i  style={{color: 'brown', marginLeft:"380px"}} class="fa fa-book" aria-hidden="true"></i>
 </Typography>
...
setTodos={setTodos}
/>
<h5 style={{color:"brown", textAlign:"center"}}> Notes  </h5>
